...
<div class="modal fade" id="registerModal">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form id="registerform" action="myseverlet" method="post" accept-charset="UTF-8" onsubmit="document.charset='UTF-8'">
				...
				<div class="form-group">
					<div class="col-xs-12  ">
						<div class="input-group">
							...
							<input type="text" name="sid" id="sid" class="form-control" placeholder="学号" maxlength="20" onfocus="$('#wxnameInfo').show()" onblur="$('#wxnameInfo').hide()">
						</div>
					</div>
				...
				<div class="form-group">
					<div class="col-xs-12  ">
						<div class="input-group">
							...
							<input type="text" name="classname" id="classname" class="form-control" placeholder="班级" maxlength="100" onfocus="$('#classInfo').show()" onblur="$('#classInfo').hide()">
						</div>
					</div>
				...
				<div class="form-group form-actions">
					<div class="col-xs-4 col-xs-offset-4 ">
						<button type="submit" class="btn btn-sm btn-info" onclick="subRegister()"><span class="glyphicon glyphicon-off"></span> 注册</button>
					</div>
				</div>
			</form>
			</div>
